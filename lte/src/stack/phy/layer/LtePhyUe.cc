...
void LtePhyUe::initialize(int stage)
{
    ...
    if (stage == inet::INITSTAGE_LOCAL)
    {
        ...
        numHandovers_ = registerSignal("numHandovers");/////////////////masoud
        phyThroughputDl_ = registerSignal("phyThroughputDl");/////////////masoud
        phyDelayDl_ = registerSignal("phyDelayDl");//////////////////masoud

        phyThroughputUl_ = registerSignal("phyThroughputUl");/////////////masoud
        phyDelayUl_ = registerSignal("phyDelayUl");//////////////////masoud
        SinrUl_= registerSignal("SinrUl");
        Dist_=registerSignal("Distance");
...
////////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
//                FILE*fp=fopen("RSSI.dat","a");
//                std::string str = std::to_string(simTime().dbl()) +" "+std::to_string(rssi)+" "+std::to_string(candidateMasterRssi_)+" "+ getParentModule()->getParentModule()->getFullName()+"\n";
//                fputs(str.c_str(),fp);
//                fclose(fp);
////////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
...
void LtePhyUe::doHandover()
{
    ...
    // collect stat
    emit(servingCell_, (long)masterId_);
    totalHandovers++;////////////////////masoud
    emit(numHandovers_,totalHandovers);////////////////////masoud

    if (getEnvir()->isGUI())//////////////////Masoud
        getParentModule()->getParentModule()->bubble("Handover complete!");///////////////Masoud
...
//            m.setStart(das_->getAntennaCoord(*it));
    ...
    //Masoud: Downlink Statistics at physical layer////////////////////////////////////
    //Throughput
    if(result)
    {
        unsigned int size = pkt->getByteLength();
        totalRcvdBytesDl_ += size;
        double tputSample = (double)totalRcvdBytesDl_ / (NOW - getSimulation()->getWarmupPeriod());
        emit(phyThroughputDl_, tputSample);
    ////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
//        FILE*fp=fopen("TotalRecBytePhy.dat","a");
//        std::string str = std::to_string(simTime().dbl()) +" "+  std::to_string(totalRcvdBytes_) +" "+  std::to_string(nodeId_)+" "+  std::to_string(tputSample)+"\n";
//        fputs(str.c_str(),fp);
//        fclose(fp);
    ////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
        //Delay:
        emit(phyDelayDl_, (NOW - pkt->getSendingTime()).dbl());
    }
    double distance = getCoord().distance(lteInfo->getCoord());
//    ////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
//          FILE*fp=fopen("DIST.dat","a");
//          std::string str = std::to_string(simTime().dbl()) +" "+  std::to_string(distance)+"\n";
//          fputs(str.c_str(),fp);
//          fclose(fp);
//   ////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
...
//    }
    ...
    if ( lteInfo->getUserTxParams() != NULL && lteInfo->getFrameType() == DATAPKT )//////////Masoud
    {
...
//    ////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
//            FILE*fp=fopen("TotalRecBytePhy.dat","a");
//            std::string str = std::to_string(simTime().dbl()) +" "+  std::to_string(cqi)+"\n";
//            fputs(str.c_str(),fp);
//            fclose(fp);
//    ////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
...
//    double cqi = uinfo->getUserTxParams()->readCqiVector()[uinfo->getCw()];
//    ////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
//    FILE*fp=fopen("TotalRecBytePhy.dat","a");
//    std::string str = std::to_string(simTime().dbl()) +" "+  std::to_string(cqi) +" "+ getParentModule()->getParentModule()->getFullName()+"\n";
//    fputs(str.c_str(),fp);
//    fclose(fp);
//    ////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
...
///////////////////////////////////Masoud/////////////////////////////////
void LtePhyUe::computeUlStatistics(unsigned int size, double delay , double RcvdTime)
{
    totalRcvdBytesUl_ += size;
    double tputSample = (double)totalRcvdBytesUl_/RcvdTime;
    emit(phyThroughputUl_,tputSample);
    emit(phyDelayUl_,delay);
}

void LtePhyUe::myRcvdSinrAtEnb(double rcvdSinr)
{
    emit(SinrUl_,rcvdSinr);
}
