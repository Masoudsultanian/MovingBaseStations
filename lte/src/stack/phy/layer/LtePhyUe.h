...
class LtePhyUe : public LtePhyBase
{
  protected:
    ...
    ///////////////////////////////////Masoud: number of handovers done by Ue///////////////////////
        simsignal_t numHandovers_;
        unsigned int totalHandovers;

        unsigned int totalRcvdBytesUl_ = 0;
        simsignal_t phyThroughputUl_;
        simsignal_t phyDelayUl_;

        unsigned int totalRcvdBytesDl_ = 0;
        simsignal_t phyThroughputDl_;
        simsignal_t phyDelayDl_;
  ...
  public:
    ...
    void computeUlStatistics(unsigned int size, double delay, double RcvdTime);///////////////Masoud
    void myRcvdSinrAtEnb(double rcvdSinr);///////////////Masoud
