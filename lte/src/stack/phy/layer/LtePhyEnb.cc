...
bool LtePhyEnb::handleControlPkt(UserControlInfo* lteinfo, LteAirFrame* frame)
{
    ...
    if (lteinfo->getFrameType() == HANDOVERPKT)//3
    {
    ...
    if (lteinfo->getFrameType() == HARQPKT//4
        || lteinfo->getFrameType() == RACPKT)//6
    {
        handleControlMsg(frame, lteinfo);
        return true;
    }
    //handle feedback pkt
    if (lteinfo->getFrameType() == FEEDBACKPKT)//2
    {
...
////////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
//        phyUe_ = check_and_cast<LtePhyUe*>(getPhyByMacNodeId(lteInfo->getSourceId()));
//        FILE*fp=fopen("everyOne.dat","a");
//        std::string str = std::to_string(simTime().dbl()) +" "+  phyUe_->getParentModule()->getParentModule()->getFullName() +" "+ std::to_string(lteInfo->getFrameType())+" "+ std::to_string(cqi)+"\n";
//        fputs(str.c_str(),fp);
//        fclose(fp);
////////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
    }
...
//////////////////////////////////////////////////// Masoud////////////////////////////////////
    if(result)
    {
       ...
       double RcvdTime = (NOW - getSimulation()->getWarmupPeriod()).dbl();
       double distance = getCoord().distance(lteInfo->getCoord());
       phyUe_->computeUlStatistics(size,delay,RcvdTime);
//////MMMMMMMMMMMMMMMMMMMMMMM Masoud MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
//       FILE*fp=fopen("POS.dat","a");
//       std::string str = std::to_string(simTime().dbl()) +" "+std::to_string(distance)+" "+ phyUe_->getParentModule()->getParentModule()->getFullName()+"\n";
//       fputs(str.c_str(),fp);
//       fclose(fp);
