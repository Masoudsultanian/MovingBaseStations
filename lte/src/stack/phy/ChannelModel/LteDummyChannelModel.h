...
class LteDummyChannelModel : public LteChannelModel
{
 ...
 public:
    ...
    */
   virtual double computePathLoss(double distance,MacNodeId eNbId, double dbp, bool los)//Masoud
   {
       return 0;
   }
   /*
    ...
    */
   virtual double getAttenuation(MacNodeId nodeId,MacNodeId eNbId, Direction dir, inet::Coord coord)//Masoud
   {
       return 0;
   }
   /*
