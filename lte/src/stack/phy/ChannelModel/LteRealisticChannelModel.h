...
private:
  ...
  LtePhyUe *phyUe_;////////////////////////Masoud
  simsignal_t FinalrcvdPower_;
...
public:
   ...
   */
  virtual double getAttenuation(MacNodeId nodeId,MacNodeId eNbId, Direction dir, inet::Coord coord);
  /*
   ...
   */
  virtual double computePathLoss(double distance,MacNodeId eNbId, double dbp, bool los);
  /*
   ...
   * @param los line-of-sight flag
   */
  double computeUrbanMacro(double distance,MacNodeId eNbId, bool los);
  /*
...
protected:
   ...
   */
  double computeExtCellPathLoss(double dist, MacNodeId nodeId, MacNodeId eNbId);
