...
class LteChannelModel : public cSimpleModule
{
  ...
  public:
     ...
     */
    virtual double getAttenuation(MacNodeId nodeId,MacNodeId eNbId, Direction dir, inet::Coord coord) = 0;//Masoud
    /*
     ...
     */
    virtual double computePathLoss(double distance,MacNodeId eNbId, double dbp, bool los) = 0;//Masoud
    /*
